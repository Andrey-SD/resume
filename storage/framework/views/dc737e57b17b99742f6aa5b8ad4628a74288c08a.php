...
<section class="contacts">
	<div class="row">
		<div class="col-md-6 col-sm-6">
			...
			<p class="kyivstar cont_list"><?php echo e($info->phone_number); ?></p></br>
			<h4>Вы можете написать мне в любое время.</h4>
			<p class="viber cont_list"><?php echo e($info->phone_number); ?></p>
			<p class="telegram cont_list">
				<a href="https://t.me/andrey_sd" title="Gmail" target="_blank"><?php echo e($info->telegram_nickname); ?></a>
			</p>
			<p class="mail cont_list">
				<a href="https://mail.google.com/mail/u/0/?tab=wm#inbox?compose=new" title="Gmail" target="_blank"><?php echo e($info->email); ?></a>
			</p>
...
<div id="prelodaer">
	<img src="<?php echo e(URL::asset('img/preloader.gif')); ?>" alt="preloder">
</div>
<script>
