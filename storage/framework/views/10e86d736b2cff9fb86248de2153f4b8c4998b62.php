...
<section class="resume">
	<div class="row">
		<div class="col-md-9 col-sm-9 col-xs-9">
			...
			<div class="row resume_row">
				<div class="col-md-2 col-sm-2 col-xs-2 resume_row_title">
					<p class="r-circle">Опыт работы</p>
				</div>
				<div class="col-md-10 col-sm-10 col-xs-10">
					...
					<p class="frs"><?php echo e($work->date); ?></p>
					<p class="scn"><?php echo e($work->name); ?></p>
					<p class="tr"><?php echo e($work->position); ?></p>
					<p style="border-bottom: 1px dotted #8B8B8B; margin-bottom:5mm !important;"><?php echo e($work->duties); ?></p>
			...
			<div class="row resume_row">
				<div class="col-md-2 col-sm-2 col-xs-2 resume_row_title">
					<p class="r-circle">Образование</p>
				</div>
				<div class="col-md-10 col-sm-10 col-xs-10">
					...
					<p class="work_tar">Место учебы: <?php echo e($education->name); ?></p>
					<p class="work_tar">Специальность: <?php echo e($education->lesson); ?></p>
					<p style="border-bottom: 1px dotted #8B8B8B; margin-bottom:5mm !important;"><?php echo e($work->duties); ?></p>
					<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
				</div>
			</div>
